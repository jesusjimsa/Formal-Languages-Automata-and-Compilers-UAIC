...
FUNCION_PRINCIPAL: S_INTEGER S_MAIN O_BRACKETS C_BRACKETS O_KEYS EXPRESIONS C_KEYS
	| S_INTEGER S_MAIN O_BRACKETS MAIN_RESERVATED C_BRACKETS O_KEYS EXPRESIONS C_KEYS
	;
MAIN_RESERVATED: S_INTEGER P_RESERVATED S_COMA S_CHAR S_ASTERISK P_RESERVATED;

FUNCION: S_VARIABLE ID O_BRACKETS C_BRACKETS O_KEYS EXPRESIONS C_KEYS
	| S_VARIABLE ID O_BRACKETS PARAMETERS C_BRACKETS O_KEYS EXPRESIONS C_KEYS
	;

PARAMETERS: S_VARIABLE ID
	| S_VARIABLE S_PARAMETER ID
	| S_VARIABLE ID S_COMA PARAMETERS
	| S_VARIABLE S_PARAMETER ID S_COMA PARAMETERS
	;
...
VARIABLE: S_VARIABLE ID S_EQUAL S_DEFINITION
	| S_VARIABLE ID
	| S_VARIABLE ID S_COMA VARIABLE
	| S_VARIABLE ID S_EQUAL S_DEFINITION S_COMA VARIABLE
	| S_CONSTANTE S_VARIABLE ID S_EQUAL S_DEFINITION
	| S_VARIABLE ID S_BOXOPEN NUM S_BOXCLOSE
	| S_VARIABLE ID S_BOXOPEN S_BOXCLOSE
	;

S_DEFINITION: NUM
	| COMILLASSIMPLES ID COMILLASSIMPLES
	| COMILLASDOBLES ID COMILLASDOBLES
	;
